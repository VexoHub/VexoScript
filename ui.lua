...
if not isfolder("VexoHub") then
    makefolder("VexoHub")
end
if not isfolder("VexoHub/Config") then
    makefolder("VexoHub/Config")
end
...
local ConfigFile = "VexoHub/Config/vexohub" .. gameName .. ".json"
...
function Chloex:MakeNotify(NotifyConfig)
    ...
    NotifyConfig.Title = NotifyConfig.Title or "VexoHub"
...
function Chloex:Window(GuiConfig)
    ...
    GuiConfig.Title        = GuiConfig.Title or "VexoHub"
    GuiConfig.Footer       = GuiConfig.Footer or "VexoHub"
